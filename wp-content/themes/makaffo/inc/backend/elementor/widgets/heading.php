 ...
 */
class Makaffo_Heading extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'sub_title',
			[
				'label' => __( 'Subtitle & Title', 'makaffo' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'our services', 'makaffo' ),
				'placeholder' => __( 'Enter your subtitle', 'makaffo' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => '',
				'type' => Controls_Manager::TEXT,
				'default' => __( 'What we do', 'makaffo' ),
				'placeholder' => __( 'Enter your title', 'makaffo' ),
				'show_label' => false,
				'label_block' => true,
			]
		);
...
// After the Makaffo_Heading class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Makaffo_Heading() );