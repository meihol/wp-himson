 ...
 * Widget Name: Logo
 */
class Makaffo_Logo extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'logo_image',
			 [
				'label' => esc_html__( 'Image', 'makaffo' ),
		...
		$this->add_control(
			'slogo_image',
			 [
				...
				'description' => esc_html__( 'Show when using Header Sticky', 'makaffo' ),
			 ]
		);
	...
	protected function render() {
		...
		?>
	    	...
	    	<div class="the-logo <?php if( !empty( $settings['slogo_image']['url'] ) ) echo 'has-slogo'; ?>">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<img src="<?php echo esc_attr( $settings['logo_image']['url'] ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">
					<?php if( !empty( $settings['slogo_image']['url'] ) ) { ?>
...
// After the Makaffo_Logo class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Makaffo_Logo() );