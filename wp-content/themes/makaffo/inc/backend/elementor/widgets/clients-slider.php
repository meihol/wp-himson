 ...
 */
class Makaffo_Clients_Slider extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Clients Slider', 'makaffo' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'logo_vertical_align',
			[
				'label' => __( 'Vertical Align', 'makaffo' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'flex-start' => [
						'title' => __( 'Start', 'makaffo' ),
...
// After the Makaffo_Clients_Slider class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Makaffo_Clients_Slider() );