 ...
 * Widget Name: Button
 */
class Makaffo_Button extends Widget_Base{
	...
	public static function get_button_style() {
		return [
			...
			'light' => esc_html__( 'Light', 'makaffo' ),
			'outline' => esc_html__( 'Outline', 'makaffo' ),
		];
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'text',
			[
				'label' => __( 'Label', 'makaffo' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Click here', 'makaffo' ),
			]
		);
		...
		$this->add_control(
			'btn_style',
			[
				'label' => esc_html__( 'Style', 'makaffo' ),
		...
		$this->add_control(
			'icon_align',
			[
				'label' => esc_html__( 'Icon Position', 'makaffo' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left' => esc_html__( 'Before', 'makaffo' ),
					'right' => esc_html__( 'After', 'makaffo' ),
				],
				'condition' => [ 
					'selected_icon[value]!' => '' 
				],
		...
		$this->add_control(
			'icon_size',
			[
				'label' => esc_html__( 'Icon Size', 'makaffo' ),
				...
				'selectors' => [
					...
					'{{WRAPPER}} .octf-btn i:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [ 
					'selected_icon[value]!' => '' 
				],
		...
		$this->add_control(
			'icon_indent',
			[
				'label' => esc_html__( 'Icon Spacing', 'makaffo' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 100,
...
// After the Makaffo_Button class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Makaffo_Button() );