 ...
 */
class Makaffo_Button_Play extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Button Play', 'makaffo' ); 
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .octf-btn-play i:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
...
// After the Makaffo_Button_Play class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Makaffo_Button_Play() );