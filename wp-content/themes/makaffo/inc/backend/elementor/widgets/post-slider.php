 ...
 */
class Makaffo_Posts_Slider extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Posts Carousel', 'makaffo' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'posts_show_number',
			[
				'label' => __( 'Show Number Post', 'makaffo' ),
		...
		$this->add_control(
			'exc',
			[
				'label' => esc_html__( 'Number Excerpt Length', 'makaffo' ),
				'type' => Controls_Manager::NUMBER,
			]
		);
		$this->add_control(
			'text_btn',
			[
				'label' => __( 'Label Button', 'makaffo' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'makaffo' ),
			]
		);
		...
		$this->add_responsive_control(
			'slider_spacing',
			[
				'label' => __( 'Slider Spacing <span class="elementor-control-field-description">(Min: 30px)</span>', 'makaffo' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 30,
			...
			<div <?php echo $this->get_render_attribute_string( 'slides' ); ?>>
				<div class="owl-carousel owl-theme">
		        	<?php while( $the_query->have_posts() ) : $the_query->the_post(); ?>
		        		...
		        		<article id="post-<?php the_ID(); ?>" <?php post_class('post-box has-post-thumbnail post-item'); ?>>
		        			<div class="post-inner">
						        ...
						        <div class="inner-post">
							        ...
							        <?php if( !empty( $settings['exc'] )){ ?>
							        <div class="entry-summary the-excerpt">
							            <?php echo makaffo_excerpt( $settings['exc'] ); ?>
							        </div>
							        <?php } ?>
							        <?php if( $settings['text_btn'] ){ ?>
							        <div class="entry-footer">
							        	<a href="<?php the_permalink(); ?>" class="more hover"><?php echo $settings['text_btn']; ?></a>
							        </div>
							        <?php } ?>
							    </div>
		        			</div>
...
// After the Makaffo_Posts_Slider class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Makaffo_Posts_Slider() );